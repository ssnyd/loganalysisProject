...
public class JedisPoolUtils {
    ...
    static {
        ...
        jedisPool = new JedisPool(c, "100.98.41.25", 6379); // 初始化连接池
//        jedisPool = new JedisPool(c, "172.20.9.76", 16379); // 初始化连接池
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            jedis.hincrBy("OPSYS:tuiguang_turntable:m:20161118","2E32",44);
            System.out.println(jedis.hgetAll("OPSYS:tuiguang_turntable:m:20161118"));
