//package com.yonyou.newProjectApi.tmp;
//
...
// */
//public class ESNStreamingProject2 {
//    //设置checkpoint
...
//    }
//
//    private static void calculatePVSta2(JavaPairDStream<String, String> modifyLogDStream) {
//        modifyLogDStream.filter(new Function<Tuple2<String, String>, Boolean>() {
//
//            private static final long serialVersionUID = 7636771539511778954L;
//
//            @Override
...
//
//            private static final long serialVersionUID = 1046905973263975021L;
//
//            @Override
...
//                return v1 + v2;
//            }
//        }, 1).foreachRDD(new VoidFunction<JavaPairRDD<String, Integer>>() {
//            @Override
...
//                        String[] lines = null;
//                        PVStat pvStat = null;
//                        List<PVStat> pvStats = new ArrayList<PVStat>();
//                        while (iterator.hasNext()) {
//                            tuple2 = iterator.next();
//                            lines = tuple2._1.split("%");
//                            pvStat = new PVStat();
//                            pvStat.setClickCount(tuple2._2);
//                            pvStat.setRegion(lines[1]);
//                            pvStat.setTimestamp(lines[0]);
//                            pvStats.add(pvStat);
//                        }
//                        if (pvStats.size()>0){
//                            JDBCUtils jdbcUtils = JDBCUtils.getInstance();
//                            Connection conn = jdbcUtils.getConnection();
//                            IPVStatDAO pvStatDAO = DAOFactory.getPVStatDAO();
//                            pvStatDAO.updataBatch(pvStats, conn);
//                            System.out.println("mysql 2 pvstat ==> " + pvStats.size());
//                            pvStats.clear();
//                            if (conn != null) {
