...
//        JavaRDD<String> myRDD = sc.textFile("file:////Users/chenxiaolei/data_coll.log");
//        //读取的每一行数据
//        JavaRDD<String> filterRDD = myRDD.filter(new Function<String, Boolean>() {
//            @Override
...
//            @Override
//            public Boolean call(String v1) throws Exception {
//                return Long.parseLong(v1.split("&")[5].split(":")[1]) >= 1484496000000l &&  Long.parseLong(v1.split("&")[5].split(":")[1]) < 1484582400000l;
//            }
//        });
//
//        //获得openid
...
//
//
//                        return str[0].split(":")[1] + "&" + str[1].split(":")[1] + "&" + str[2].split(":")[1];
//                    }
//                }).coalesce(1);
//
//        System.out.println(coalesce.count());
//        //.count();
//
//
//
