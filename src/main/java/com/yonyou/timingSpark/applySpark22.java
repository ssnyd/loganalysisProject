 ...
 */
public class applySpark22 {
    public static void main(String[] args) {
        SparkConf sconf = new SparkConf()
                .setAppName("applySpark2222")
...
//      scan.setStopRow(Bytes.toBytes(getTimes("2016:11:28")+"::"));
        ...
        try {
            ...
            instanceRDD.saveAsTextFile("hdfs://cluster/1219/instance");
            qzRDD.saveAsTextFile("hdfs://cluster/1219/qz");
            memRDD.saveAsTextFile("hdfs://cluster/1219/mem");
            numrdd.saveAsTextFile("hdfs://cluster/1219/num");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
